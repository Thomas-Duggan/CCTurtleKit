...
Note for `startup.lua`: This file is NOT neccessary for proper usage of `CCTurtleKit.lua`. It is exclusively for ease of setup and ease of use and is only required if you want it. 
